import { CarouselGridConfig, fieldsToListingPage } from "@/utils";
...
export const GenericBrandCardMobile = ({
  ...
  const widthStyle: React.CSSProperties = {
    width: `${(component_config?.width || 0.4) * (parentWidth || 100)}px`, // Use full width in carousel mode
  };
  ...
  return (
    <div style={widthStyle}>
      ...
      <div style={combinedStyle}>
        <a href={url}>
          <img src={data.image} style={cornerRadiusStyle} />
        </a>
      </div>
